...
const storySchema = new Schema(
  {
    ...
    chapterBundleEnabled: { type: Boolean, default: false },
    chapterBundleSize: { type: Number, default: 3 },
    chapterBundleDiscountPercent: { type: Number, default: 15 },
    supportEnabled: { type: Boolean, default: false },
    supportTotalAmount: { type: Number, default: 0 },
